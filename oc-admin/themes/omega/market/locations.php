...
<div id="market-block" class="<?php echo osc_esc_html($action); ?>">
  <div id="mrkt" class="languages locations">
    ...
    <?php if(is_array($products) && count($products) > 0) { ?>
      <div class="info"><?php echo sprintf(__('Locations contains country, region and city data those are used in diffrent situations by osclass. You may automatically install locations from the %s or upload a location in .sql format.'), '<a href="#/locations">' . __('OsclassPoint Locations Directory') . '</a>'); ?></div>
