    ...
    if(@$_get['s_name'] != '') {
      ...
      if(@$_get['userId'] == '') {
        if(substr($_get['user'], 0, 1) == '"' || substr($_get['user'], -1) == '"') {
          ...
          $this->conditions["(s_email = '" . $esc_user . "' OR s_name = '" . $esc_user . "' OR s_phone_mobile = '" . $esc_user . "' OR s_phone_land = '" . $esc_user . "')"] = null;
        } else {
          $esc_user = User::newInstance()->dao->escapeStr(str_replace('%%', '%', str_replace('*','%', '%' . $_get['user'] . '%')));
          $this->conditions["(s_email LIKE '" . $esc_user . "' OR s_name LIKE '" . $esc_user . "' OR s_phone_mobile LIKE '" . $esc_user . "' OR s_phone_land LIKE '" . $esc_user . "')"] = null;
        }
      } else {
