<?php
    ...
    dreamfree_add_body_class('error not-found');
    osc_current_web_theme_path('header.php') ;
?>
<div class="flashmessage-404">
    <h1><?php _e("Sorry but I can't find the page you're looking for", 'dreamfree') ; ?></h1>

    <p><?php _e("Let us help you, we have got a few tips for you to find it.", 'dreamfree') ; ?></p>
    <ul>
        <li>
            <?php _e("<strong>Search</strong> for it:", 'dreamfree') ; ?>
            <form action="<?php echo osc_base_url(true) ; ?>" method="get" class="search">
                <input type="hidden" name="page" value="search" />
                <fieldset class="main">
                    <input type="text" name="sPattern"  id="query" value="" />
                    <button type="submit" class="btn btn-danger flash404"><?php _e('Search', 'dreamfree') ; ?></button>
                </fieldset>
            </form>
        </li>
        <li><?php _e("<strong>Look</strong> for it in the most popular categories.", 'dreamfree') ; ?>
