$(document).ready(function(){
  ...
  // ON COUNTRY CHANGE RELOAD PAGE
  $('body').on('change', 'select.mb-select-country', function(e){
    window.location.replace($(this).attr('rel') + "&activeCountry=" + $(this).val());
  });

  // ON REGION CHANGE RELOAD PAGE
  $('body').on('change', 'select.mb-select-region', function(e){
    window.location.replace($(this).attr('rel') + "&activeRegion=" + $(this).val());
  });
